...
# We will set pageHistory to "0,1,2,3,4" to signify that all 5 sections were completed.
payload = {
    # Session data
    "fbzx": fbzx,
    "fvv": fvv,
    ...
    # Answers
    "entry.1263102269": "TEST PAGE HISTORY 01234",
    "entry.1052711449": "2409106999", # NIM
    ...
    "entry.1831604431": "Website ini sangat berguna dan mempercepat administrasi.",
    "entry.1844992149": "Saran agar kecepatan aksesnya terus dioptimalkan.",
    
    # Email
    "emailAddress": "testpagehistory@gmail.com"
}
...
if "Jawaban Anda telah direkam" in response.text:
    print("SUCCESS: Submitted with complete pageHistory!")
else:
